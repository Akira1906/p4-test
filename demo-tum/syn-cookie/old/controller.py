    ...
    def recv_msg_digest(self, msg):
        ...
        if msg_type == 0:
            ...
            print("message type:", msg_type, 
                "src ip:", str(ipaddress.IPv4Address(arg1)), 
                "dst ip:", str(ipaddress.IPv4Address(arg2)))
            self.controller.table_add("whitelist", "NoAction", [str(ipaddress.IPv4Address(arg1))])

        elif msg_type == 2:
            print("message type:", msg_type, 
                "connection is added with Hash:", str(arg1), 
                "diff:", str(arg2))
            self.controller.table_add("connections", "saveDifferenceValue", [str(arg1)], [str(arg2)])

            print("message type:", msg_type, 
                "connection is added with Hash:", str(arg3), 
                "diff:", str(arg4))
